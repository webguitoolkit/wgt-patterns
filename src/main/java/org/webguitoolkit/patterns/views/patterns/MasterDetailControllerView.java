...
public class MasterDetailControllerView extends AbstractView {
	...
	public MasterDetailControllerView(WebGuiFactory factory, ICanvas viewConnector) {
	...
	protected void createControls(WebGuiFactory factory, ICanvas viewConnector) {
		...
		summaryCompound = factory.createCompound(summaryTab, null);
		summaryCompound.setBag(new DataBag("")); // TODO

		IButtonBar summaryButtonBar = factory.createButtonBar(summaryCompound, "edit,delete,cancel,save,new", new ButtonBarListener(
				summaryCompound));
		...
		detailCompound = factory.createCompound(detailTab, null);
		detailCompound.setBag(new DataBag("")); // TODO

		IButtonBar detailButtonBar = factory.createButtonBar(detailCompound, "edit,cancel,save", new ButtonBarListener(detailCompound));
		...
		mdc.setTabStrip(tabstrip);
		mdc.addMasterCompound(summaryCompound, summaryButtonBar);
		mdc.addMasterCompound(detailCompound, detailButtonBar);
	}

	/**
	 * This extension of the AbstractButtonBarListener is just for demo purposes.
	 * 
	 * @author i102374
	 * 
	 */
