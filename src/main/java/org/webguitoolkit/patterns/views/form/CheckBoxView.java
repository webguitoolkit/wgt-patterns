...
public class CheckBoxView extends AbstractView{
	...
	public CheckBoxView(WebGuiFactory factory, ICanvas viewConnector) {
	...
	protected void createControls( WebGuiFactory factory, ICanvas viewConnector ) {
		...
		// create label
		ILabel label = factory.createLabel(layout, "Checkbox");

		// create CheckBox
		ICheckBox checkbox = factory.createCheckBox( layout, "check1" );
		...
		ICheckBox cbLabel = factory.createCheckBox( layout, "check2" );
		cbLabel.setLabelKey( "label" );
